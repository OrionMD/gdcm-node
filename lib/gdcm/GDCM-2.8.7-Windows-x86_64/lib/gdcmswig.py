...
GDCM_FUNCTION = _gdcmswig.GDCM_FUNCTION
class UIDs(_object):
    """
...
def Testing_GetNumberOfMediaStorageDataFiles() -> "unsigned int":
...
def Testing_GetMediaStorageDataFile(file: 'unsigned int') -> "char const *const *":
...
def Testing_GetMediaStorageFromFile(filepath: 'char const *') -> "char const *":
...
def Testing_GetMD5DataImages() -> "gdcm::Testing::MD5DataImagesType":
    return _gdcmswig.Testing_GetMD5DataImages()
Testing_GetMD5DataImages = _gdcmswig.Testing_GetMD5DataImages

def Testing_GetNumberOfMD5DataImages() -> "unsigned int":
...
def Testing_GetStreamOffsetFromFile(filepath: 'char const *') -> "std::streamoff":
...
def Testing_GetSelectedTagsOffsetFromFile(filepath: 'char const *') -> "std::streamoff":
...
def Testing_GetSelectedPrivateGroupOffsetFromFile(filepath: 'char const *') -> "std::streamoff":
...
def Testing_GetLossyFlagFromFile(filepath: 'char const *') -> "int":

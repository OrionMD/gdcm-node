...
def SwapCode_GetSwapCodeString(sc):
...
def PhotometricInterpretation_GetPIString(pi):
...
def PhotometricInterpretation_GetPIType(pi):
...
def PhotometricInterpretation_IsRetired(pi):
...
def Overlay_GetOverlayTypeAsString(ot):
...
def Overlay_GetOverlayTypeFromString(arg2):
...
def FileMetaInformation_SetImplementationClassUID(imp):
...
def FileMetaInformation_AppendImplementationClassUID(imp):
...
def FileMetaInformation_SetImplementationVersionName(version):
...
def FileMetaInformation_SetSourceApplicationEntityTitle(title):
...
def UIDs_GetTransferSyntaxString(ts):
...
def DirectionCosines_Normalize(*args):
    """
    void
    gdcm::DirectionCosines::Normalize()
...
def Curve_GetNumberOfCurves(ds):
...
def Filename_Join(path, filename):
...
def Defs_GetIODNameFromMediaStorage(ms):
...
class Rescaler(_object):
    ...
    def InverseRescale(self, out, arg3, n):
        """
        bool
...
class Testing(_object):
    ...
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, Testing, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, Testing, name)
    __repr__ = _swig_repr

    def __init__(self):
        """gdcm::Testing::Testing() """
        this = _gdcmswig.new_Testing()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __del__ = lambda self: None
    if _newclass:
        ComputeMD5 = staticmethod(_gdcmswig.Testing_ComputeMD5)
    else:
        ComputeMD5 = _gdcmswig.Testing_ComputeMD5
    ...
    if _newclass:
        GetFileNames = staticmethod(_gdcmswig.Testing_GetFileNames)
    else:
        GetFileNames = _gdcmswig.Testing_GetFileNames
    if _newclass:
        GetNumberOfFileNames = staticmethod(_gdcmswig.Testing_GetNumberOfFileNames)
    else:
        GetNumberOfFileNames = _gdcmswig.Testing_GetNumberOfFileNames
    if _newclass:
        GetFileName = staticmethod(_gdcmswig.Testing_GetFileName)
    else:
        GetFileName = _gdcmswig.Testing_GetFileName
    if _newclass:
        GetMediaStorageDataFiles = staticmethod(_gdcmswig.Testing_GetMediaStorageDataFiles)
    else:
        GetMediaStorageDataFiles = _gdcmswig.Testing_GetMediaStorageDataFiles
    if _newclass:
        GetNumberOfMediaStorageDataFiles = staticmethod(_gdcmswig.Testing_GetNumberOfMediaStorageDataFiles)
    else:
        GetNumberOfMediaStorageDataFiles = _gdcmswig.Testing_GetNumberOfMediaStorageDataFiles
    if _newclass:
        GetMediaStorageDataFile = staticmethod(_gdcmswig.Testing_GetMediaStorageDataFile)
    else:
        GetMediaStorageDataFile = _gdcmswig.Testing_GetMediaStorageDataFile
    if _newclass:
        GetMediaStorageFromFile = staticmethod(_gdcmswig.Testing_GetMediaStorageFromFile)
    else:
        GetMediaStorageFromFile = _gdcmswig.Testing_GetMediaStorageFromFile
    if _newclass:
        GetMD5DataImages = staticmethod(_gdcmswig.Testing_GetMD5DataImages)
    else:
        GetMD5DataImages = _gdcmswig.Testing_GetMD5DataImages
    if _newclass:
        GetNumberOfMD5DataImages = staticmethod(_gdcmswig.Testing_GetNumberOfMD5DataImages)
    else:
        GetNumberOfMD5DataImages = _gdcmswig.Testing_GetNumberOfMD5DataImages
    if _newclass:
        GetMD5DataImage = staticmethod(_gdcmswig.Testing_GetMD5DataImage)
    else:
        GetMD5DataImage = _gdcmswig.Testing_GetMD5DataImage
    if _newclass:
        GetMD5FromFile = staticmethod(_gdcmswig.Testing_GetMD5FromFile)
    else:
        GetMD5FromFile = _gdcmswig.Testing_GetMD5FromFile
    if _newclass:
        GetMD5FromBrokenFile = staticmethod(_gdcmswig.Testing_GetMD5FromBrokenFile)
    else:
        GetMD5FromBrokenFile = _gdcmswig.Testing_GetMD5FromBrokenFile
    if _newclass:
        GetStreamOffsetFromFile = staticmethod(_gdcmswig.Testing_GetStreamOffsetFromFile)
    else:
        GetStreamOffsetFromFile = _gdcmswig.Testing_GetStreamOffsetFromFile
    if _newclass:
        GetSelectedTagsOffsetFromFile = staticmethod(_gdcmswig.Testing_GetSelectedTagsOffsetFromFile)
    else:
        GetSelectedTagsOffsetFromFile = _gdcmswig.Testing_GetSelectedTagsOffsetFromFile
    if _newclass:
        GetSelectedPrivateGroupOffsetFromFile = staticmethod(_gdcmswig.Testing_GetSelectedPrivateGroupOffsetFromFile)
    else:
        GetSelectedPrivateGroupOffsetFromFile = _gdcmswig.Testing_GetSelectedPrivateGroupOffsetFromFile
    if _newclass:
        GetLossyFlagFromFile = staticmethod(_gdcmswig.Testing_GetLossyFlagFromFile)
    else:
        GetLossyFlagFromFile = _gdcmswig.Testing_GetLossyFlagFromFile
    if _newclass:
        GetDataRoot = staticmethod(_gdcmswig.Testing_GetDataRoot)
    else:
        GetDataRoot = _gdcmswig.Testing_GetDataRoot
    if _newclass:
        GetDataExtraRoot = staticmethod(_gdcmswig.Testing_GetDataExtraRoot)
    else:
        GetDataExtraRoot = _gdcmswig.Testing_GetDataExtraRoot
    if _newclass:
        GetPixelSpacingDataRoot = staticmethod(_gdcmswig.Testing_GetPixelSpacingDataRoot)
    else:
        GetPixelSpacingDataRoot = _gdcmswig.Testing_GetPixelSpacingDataRoot
    if _newclass:
        GetTempDirectory = staticmethod(_gdcmswig.Testing_GetTempDirectory)
    else:
        GetTempDirectory = _gdcmswig.Testing_GetTempDirectory
    if _newclass:
        GetTempDirectoryW = staticmethod(_gdcmswig.Testing_GetTempDirectoryW)
    else:
        GetTempDirectoryW = _gdcmswig.Testing_GetTempDirectoryW
    if _newclass:
        GetTempFilename = staticmethod(_gdcmswig.Testing_GetTempFilename)
    else:
        GetTempFilename = _gdcmswig.Testing_GetTempFilename
    if _newclass:
        GetTempFilenameW = staticmethod(_gdcmswig.Testing_GetTempFilenameW)
    else:
        GetTempFilenameW = _gdcmswig.Testing_GetTempFilenameW
    if _newclass:
        GetSourceDirectory = staticmethod(_gdcmswig.Testing_GetSourceDirectory)
    else:
        GetSourceDirectory = _gdcmswig.Testing_GetSourceDirectory
    if _newclass:
        ComputeFileMD5 = staticmethod(_gdcmswig.Testing_ComputeFileMD5)
    else:
        ComputeFileMD5 = _gdcmswig.Testing_ComputeFileMD5
Testing_swigregister = _gdcmswig.Testing_swigregister
Testing_swigregister(Testing)

def Testing_ComputeMD5(buffer, buf_len, digest_str):
    return _gdcmswig.Testing_ComputeMD5(buffer, buf_len, digest_str)
Testing_ComputeMD5 = _gdcmswig.Testing_ComputeMD5

def Testing_GetFileNames():
    return _gdcmswig.Testing_GetFileNames()
Testing_GetFileNames = _gdcmswig.Testing_GetFileNames

def Testing_GetNumberOfFileNames():
    return _gdcmswig.Testing_GetNumberOfFileNames()
Testing_GetNumberOfFileNames = _gdcmswig.Testing_GetNumberOfFileNames

def Testing_GetFileName(file):
    return _gdcmswig.Testing_GetFileName(file)
Testing_GetFileName = _gdcmswig.Testing_GetFileName

def Testing_GetMediaStorageDataFiles():
    return _gdcmswig.Testing_GetMediaStorageDataFiles()
Testing_GetMediaStorageDataFiles = _gdcmswig.Testing_GetMediaStorageDataFiles

def Testing_GetNumberOfMediaStorageDataFiles():
    return _gdcmswig.Testing_GetNumberOfMediaStorageDataFiles()
Testing_GetNumberOfMediaStorageDataFiles = _gdcmswig.Testing_GetNumberOfMediaStorageDataFiles

def Testing_GetMediaStorageDataFile(file):
    return _gdcmswig.Testing_GetMediaStorageDataFile(file)
Testing_GetMediaStorageDataFile = _gdcmswig.Testing_GetMediaStorageDataFile

def Testing_GetMediaStorageFromFile(filepath):
    return _gdcmswig.Testing_GetMediaStorageFromFile(filepath)
Testing_GetMediaStorageFromFile = _gdcmswig.Testing_GetMediaStorageFromFile

def Testing_GetMD5DataImages():
    return _gdcmswig.Testing_GetMD5DataImages()
Testing_GetMD5DataImages = _gdcmswig.Testing_GetMD5DataImages

def Testing_GetNumberOfMD5DataImages():
    return _gdcmswig.Testing_GetNumberOfMD5DataImages()
Testing_GetNumberOfMD5DataImages = _gdcmswig.Testing_GetNumberOfMD5DataImages

def Testing_GetMD5DataImage(file):
    return _gdcmswig.Testing_GetMD5DataImage(file)
Testing_GetMD5DataImage = _gdcmswig.Testing_GetMD5DataImage

def Testing_GetMD5FromFile(filepath):
    return _gdcmswig.Testing_GetMD5FromFile(filepath)
Testing_GetMD5FromFile = _gdcmswig.Testing_GetMD5FromFile

def Testing_GetMD5FromBrokenFile(filepath):
    return _gdcmswig.Testing_GetMD5FromBrokenFile(filepath)
Testing_GetMD5FromBrokenFile = _gdcmswig.Testing_GetMD5FromBrokenFile

def Testing_GetStreamOffsetFromFile(filepath):
    return _gdcmswig.Testing_GetStreamOffsetFromFile(filepath)
Testing_GetStreamOffsetFromFile = _gdcmswig.Testing_GetStreamOffsetFromFile

def Testing_GetSelectedTagsOffsetFromFile(filepath):
    return _gdcmswig.Testing_GetSelectedTagsOffsetFromFile(filepath)
Testing_GetSelectedTagsOffsetFromFile = _gdcmswig.Testing_GetSelectedTagsOffsetFromFile

def Testing_GetSelectedPrivateGroupOffsetFromFile(filepath):
    return _gdcmswig.Testing_GetSelectedPrivateGroupOffsetFromFile(filepath)
Testing_GetSelectedPrivateGroupOffsetFromFile = _gdcmswig.Testing_GetSelectedPrivateGroupOffsetFromFile

def Testing_GetLossyFlagFromFile(filepath):
    return _gdcmswig.Testing_GetLossyFlagFromFile(filepath)
Testing_GetLossyFlagFromFile = _gdcmswig.Testing_GetLossyFlagFromFile

def Testing_GetDataRoot():
    return _gdcmswig.Testing_GetDataRoot()
Testing_GetDataRoot = _gdcmswig.Testing_GetDataRoot

def Testing_GetDataExtraRoot():
    return _gdcmswig.Testing_GetDataExtraRoot()
Testing_GetDataExtraRoot = _gdcmswig.Testing_GetDataExtraRoot

def Testing_GetPixelSpacingDataRoot():
    return _gdcmswig.Testing_GetPixelSpacingDataRoot()
Testing_GetPixelSpacingDataRoot = _gdcmswig.Testing_GetPixelSpacingDataRoot

def Testing_GetTempDirectory(subdir=None):
    return _gdcmswig.Testing_GetTempDirectory(subdir)
Testing_GetTempDirectory = _gdcmswig.Testing_GetTempDirectory

def Testing_GetTempDirectoryW(subdir=None):
    return _gdcmswig.Testing_GetTempDirectoryW(subdir)
Testing_GetTempDirectoryW = _gdcmswig.Testing_GetTempDirectoryW

def Testing_GetTempFilename(filename, subdir=None):
    return _gdcmswig.Testing_GetTempFilename(filename, subdir)
Testing_GetTempFilename = _gdcmswig.Testing_GetTempFilename

def Testing_GetTempFilenameW(filename, subdir=None):
    return _gdcmswig.Testing_GetTempFilenameW(filename, subdir)
Testing_GetTempFilenameW = _gdcmswig.Testing_GetTempFilenameW

def Testing_GetSourceDirectory():
    return _gdcmswig.Testing_GetSourceDirectory()
Testing_GetSourceDirectory = _gdcmswig.Testing_GetSourceDirectory

def Testing_ComputeFileMD5(*args):
    return _gdcmswig.Testing_ComputeFileMD5(*args)
Testing_ComputeFileMD5 = _gdcmswig.Testing_ComputeFileMD5
...
def SOPClassUIDToIOD_GetIOD(uid):
...
def SOPClassUIDToIOD_GetSOPClassUIDToIOD(i):
...
def SOPClassUIDToIOD_GetSOPClassUIDFromIOD(iod):
...
def SOPClassUIDToIOD_GetIODFromSOPClassUID(sopclassuid):
...
class RLECodec(ImageCodec):
    ...
    def GetHeaderInfo(self, arg2, ts):
        """
        bool
...
def SplitMosaicFilter_GetAcquisitionSize(size, ds):
...
def SplitMosaicFilter_GetNumberOfImagesInMosaic(file):
...
def DataSetHelper_ComputeVR(file, ds, tag):
...
def ImageHelper_SetForceRescaleInterceptSlope(arg2):
...
def ImageHelper_SetPMSRescaleInterceptSlope(arg2):
...
def ImageHelper_SetForcePixelSpacing(arg2):
...
def ImageHelper_GetPixelFormatValue(f):
...
def ImageHelper_GetRescaleInterceptSlopeValue(f):
...
def ImageHelper_SetRescaleInterceptSlopeValue(f, img):
...
def ImageHelper_GetRealWorldValueMappingContent(f, rwvmc):
...
def ImageHelper_SetDirectionCosinesValue(ds, dircos):
...
def ImageHelper_GetDirectionCosinesFromDataSet(ds, dircos):
...
def ImageHelper_GetPhotometricInterpretationValue(f):
...
def ImageHelper_GetPlanarConfigurationValue(f):
...
def DummyValueGenerator_Generate(input):
...
class CryptographicMessageSyntax(_object):
    ...
    def SetPassword(self, arg2, passLen):
        """
...
def Spacing_ComputePixelAspectRatioFromPixelSpacing(pixelspacing):
...
def BaseRootQuery_GetQueryLevelString(ql):
...
def BaseRootQuery_GetQueryLevelFromString(str):
...
def BaseRootQuery_Construct(inRootType, qlevel):
...
def QueryFactory_ProduceCharacterSetDataElement(inCharSetType):
...
def QueryFactory_ListCharSets(os):
...
def CompositeNetworkFunctions_CEcho(remote, portno, aetitle=None, call=None):
...
def CompositeNetworkFunctions_CMove(remote, portno, query, portscp, aetitle=None, call=None, outputdir=None):
...
def CompositeNetworkFunctions_CFind(remote, portno, query, retDataSets, aetitle=None, call=None):
...
def CompositeNetworkFunctions_CStore(remote, portno, filenames, aetitle=None, call=None):
...
def BoxRegion_BoundingBox(b1, b2):
...
class ImageRegionReader(ImageReader):
    ...
    def ReadIntoBuffer(self, inreadbuffer, buflen):
        """
        bool
